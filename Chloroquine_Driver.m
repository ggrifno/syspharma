...
%SENSITIVITY AND MALARIA PHARMACODYNAMICS.THIS IS GREATLY REDUCED FOR THE PROJECT DRAFT FOR CODE SPEED (WOULD TAKE ~1 HOUR OTHERWISE)
...
MIC = 0.067;   %literature reported value for MIC is 0.0067
...
[Parasites_at_end1MIC1, percentCured1MIC1] = Chloroquine_Malaria(DosingRegimen, doseRange,rangekP,rangeBurden, FirstDosing,OtherDosing,timepoints,kP_vector1, P0_vector1,FirstDoseRange, SecondDoseRange, patients, MIC1, MissedDose,DisplayPlots);

save fig1A_MIC1.mat percentCured1MIC1 kP_vector1 totalDose;

% figure 1 MIC 2
MIC2 = 2*0.067;
[Parasites_at_end1MIC2, percentCured1MIC2] = Chloroquine_Malaria(DosingRegimen, doseRange,rangekP,rangeBurden, FirstDosing,OtherDosing,timepoints,kP_vector1, P0_vector1,FirstDoseRange, SecondDoseRange, patients, MIC2, MissedDose,DisplayPlots);

save fig1B_MIC2.mat percentCured1MIC2 kP_vector1 totalDose;
disp('done with Malaria PD figure 1');
...
totalDose = FirstDoseRange + 3.*SecondDoseRange;
MIC1 = 0.067;
[Parasites_at_end2MIC1, percentCured2MIC1] = Chloroquine_Malaria(DosingRegimen, doseRange,rangekP,rangeBurden, FirstDosing,OtherDosing,timepoints,kP_vector2, P0_vector2,FirstDoseRange, SecondDoseRange, patients, MIC1, MissedDose,DisplayPlots);

save fig2AMIC1.mat percentCured2MIC1 P0_vector2 totalDose;

% figure 2 MIC 2
MIC2 = 2*0.067;
[Parasites_at_end2MIC2, percentCured2MIC2] = Chloroquine_Malaria(DosingRegimen, doseRange,rangekP,rangeBurden, FirstDosing,OtherDosing,timepoints,kP_vector2, P0_vector2,FirstDoseRange, SecondDoseRange, patients, MIC2, MissedDose,DisplayPlots);

save fig2AMIC2.mat percentCured2MIC2 P0_vector2 totalDose;
disp('done with Malaria PD figure 2');
...
totalDose = FirstDoseRange + 3.*SecondDoseRange;
MIC1 = 0.067;
[Parasites_at_end3MIC1, percentCured3MIC1] = Chloroquine_Malaria(DosingRegimen, doseRange,rangekP,rangeBurden, FirstDosing,OtherDosing,timepoints,kP_vector1, P0_vector1,FirstDoseRange, SecondDoseRange, patients, MIC1, MissedDose,DisplayPlots);

save fig3Malaria.mat percentCured3MIC1 kP_vector3 totalDose;
