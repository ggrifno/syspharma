...
% q  = p(1);
% v1 = p(2);     % units = L, central compartment of chloroquine
% v2 = p(3);    % units - L, peripheral compartment of chloroquine
% v3 = p(4);    % units = L, central compartment of DCQ
% v4 = p(5);  % units = L, peripheral compartment of DCQ
% k10= p(6);
% k30= p(7);
% k12= p(8);
% k21= p(9);
...
% 
% %back when variables were hard-coded into this simuationfile 
% q = 0;
% ka = ptemp(7);
