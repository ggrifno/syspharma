...
RUN INSTRUCTIONS
- You will need to run ALL 4 CASES of the missed dose simulation for appMalariaVsCovid.m to run
...
To run appLocalSensitivity.R:
1) Run the driver sections for BOTH Malaria and COVID-19

To run app_varDose.R:
1) Run the driver sections for BOTH malaria and COVID-19
